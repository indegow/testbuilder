...
describe('Discover', function() {
  ...
  it('has a prefix of 649 and a length of 19', function() {
   ...
   it('has a prefix of 65 and a length of 16', function() {
    expect(detectNetwork('6571123456789012')).to.equal('Discover');
  });

  it('has a prefix of 65 and a length of 19', function() {
    expect(detectNetwork('6571123456789012345')).to.equal('Discover');
  });
...
describe('should support China UnionPay', function() {
  ...
  (function(prefix) {
    it('has a prefix of ' + prefix + ' and a length of 16', function() {
      expect(detectNetwork(prefix.toString() + '0000000000')).to.equal('China UnionPay');
    });
    it('has a prefix of ' + prefix + ' and a length of 17', function() {
      expect(detectNetwork(prefix.toString() + '00000000000')).to.equal('China UnionPay');
    });
    it('has a prefix of ' + prefix + ' and a length of 18', function() {
      expect(detectNetwork(prefix.toString() + '000000000000')).to.equal('China UnionPay');
    });
    it('has a prefix of ' + prefix + ' and a length of 19', function() {
      expect(detectNetwork(prefix.toString() + '0000000000000')).to.equal('China UnionPay');
    });
  ...
  (function(prefix) {
    ...
    it('has a prefix of ' + prefix + ' and a length of 17', function() {
      expect(detectNetwork(prefix.toString() + '00000000000000')).to.equal('China UnionPay');
    });
    it('has a prefix of ' + prefix + ' and a length of 18', function() {
      expect(detectNetwork(prefix.toString() + '000000000000000')).to.equal('China UnionPay');
    });
    it('has a prefix of ' + prefix + ' and a length of 19', function() {
      expect(detectNetwork(prefix.toString() + '0000000000000000')).to.equal('China UnionPay');
    });
